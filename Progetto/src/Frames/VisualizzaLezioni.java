...
public class VisualizzaLezioni extends JFrame {
	...
	public VisualizzaLezioni() {
		...
		scrollPaneCorsi.setBorder(BorderFactory.createTitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK), "Corsi"));
		...
		scrollPaneLezioni.setBorder(BorderFactory.createTitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black), "Lista Lezioni"));
		...
		panelModificaCorso.setBorder(BorderFactory.createTitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black), "Modifica Lezione"));
...
//			modelLezioni.addAll(listaDateLezioni);
		...
		updateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				controller.inserisciLezione(tmpCorso, titoloField, dateChooser, spinnerInizio, spinnerDurata, textAreaDescrizione, format ,lezioneId ,1);
