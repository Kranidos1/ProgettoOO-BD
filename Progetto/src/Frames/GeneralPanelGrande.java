...
public class GeneralPanelGrande extends JPanel {
	...
	public GeneralPanelGrande(){
		...
		JMenuItem gestisciPresenzeMenuItem = new JMenuItem("Gestisci Presenze");
		...
		labelHourDate.setBounds(358, 548, 265, 53);
