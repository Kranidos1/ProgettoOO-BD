...
public class IscriviStudenteFrame extends JFrame {
	...
	private JTextField corsoTextField;
	...
	public IscriviStudenteFrame() {
		...
		corsoTextField = new JTextField();
		corsoTextField.setBounds(160, 144, 150, 20);
		panel.add(corsoTextField);
		corsoTextField.setColumns(50);
		...
		corsoLabel.setBounds(64, 144, 86, 20);
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				controller.controlloInserimento(nomeTextField, cognomeTextField, corsoTextField, dateChooser, cfLabel, cfTextField);
